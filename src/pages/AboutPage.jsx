...
const experiences = [
  {
    ...
    details: [
      "Developed RESTful APIs using NestJS and MongoDB for a real-time communication platform.",
      "Built a WebRTC signaling server with ICE/TURN config and JWT-based authentication.",
      "Designed and developed backend architecture supporting WebRTC and VideoSDK workflows.",
      "Integrated Prometheus and Grafana for monitoring API usage and system performance.",
      "Collaborated in Agile sprints, performing version control with GitHub and implementing CI/CD using GitHub Actions.",
    ],
    bgColor: "bg-blue-50",
  ...
  },
  {
    ...
    details: [
      "Automated user provisioning and access control workflows using Python and GUI scripting, improving operational efficiency across enterprise environments.",
      "Led the migration of user roles and implemented security logic across 100+ systems during global infrastructure transitions.",
      "Designed and built internal tools and dashboards for compliance reporting, audit preparation, and access lifecycle management, with integrated unit testing.",
      "Guided a 2-member team to troubleshoot technical issues, manage incidents, and maintain backend user access infrastructure.",
    ],
    bgColor: "bg-blue-50",
    borderColor: "border-blue-400",
  },
